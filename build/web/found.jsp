                ...
                <table style="color: #330066; border-style: ridge !important" border="2px">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <c:if test="${sessionScope.account.isAdmin == true}">
                                    <a href="updatecustomer?cid=${c.cid}" class="btn btn-primary" style="padding: 6px 6px" >Update customer's information</a>
                                    <a href="listallbooking?guestusename=${c.guestusename}" class="btn btn-primary" style="padding: 6px 6px" >Show booking information</a>
                                </c:if>
                            </td>
                        </tr>
